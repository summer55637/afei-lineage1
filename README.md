...
- Event69／70 精靈少女前傳已從精簡前置拆成正式核心流程：
  ...
  - Floor 30605 里昂蛙王戰依 `event69_5.arg` 實裝；原編成 EnemyID 1685 ×1 + 1681 ×9，現有單體戰鬥核心以 1685 代表整隊
...
- PC團三層與老大戰都接入現有戰鬥核心；原多人編成完整保存於資料層，畫面目前仍以單體代表該編成
- Event81 的戰鬥地圖使用 quest stage 鎖定，未到正確階段不會生成對應敵人
